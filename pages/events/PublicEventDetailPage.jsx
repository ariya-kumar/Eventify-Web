...
const PublicEventDetailPage = () => {
  ...
  useEffect(() => {
    ...
    socket.on('bookingUpdate', (data) => {
      if (id && data.eventId === id) {
        setEvent(prev => {
          if (!prev) return prev;
          return { ...prev, availableTickets: data.availableTickets };
        });
      }
    });
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-4 flex space-x-4">
              ...
              <span className="bg-green-100 text-green-800 text-sm font-medium px-2.5 py-0.5 rounded flex items-center">
                ...
                {event.availableTickets !== undefined ? `${event.availableTickets} Tickets Left` : 'Checking Availability...'}
              </span>
            </div>
